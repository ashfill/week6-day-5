...
namespace WebApplication1.Controllers
{
    ...
    {
        private ToDoList1Entities db = new ToDoList1Entities();
        ...
        public ActionResult Create([Bind(Include = "TaskID,TaskName,Description,DueDate,CompletionDate,UserID")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TaskID,TaskName,Description,DueDate,CompletionDate,UserID")] Task task)
        {
            if (ModelState.IsValid)
            {
